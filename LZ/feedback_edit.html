        ...
        <div class="layui-tab-item layui-show">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-inline input-custom-width">
              <input type="text" name="title" value="demo" lay-verify="required" autocomplete="off" placeholder="请输入标题" class="layui-input">
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">修改时间</label>
            <div class="layui-input-inline input-custom-width">
              <input type="text" name="create_time" value="2017-03-27 10:47:42" id="date" lay-verify="datetime" placeholder="YYYY-MM-DD hh:mm:ss" autocomplete="off" class="layui-input" onclick="layui.laydate({elem: this,istime: 1, format: 'YYYY-MM-DD hh:mm:ss' })">
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">文本内容</label>
            <div class="layui-input-block">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. A autem, consequatur corporis cupiditate dicta doloribus dolorum ducimus, eveniet impedit iure maiores nemo nihil nostrum obcaecati placeat reiciendis reprehenderit sed unde!
            </div>
          </div>
          <!--<div class="layui-form-item">-->
