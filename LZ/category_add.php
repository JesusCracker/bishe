...
<div class="layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
      <a href="category_list.php"><li>文件列表</li></a>
      <a href="category_add.php"><li class="layui-this">编辑文件</li></a>
...
<!--                </div>-->
                <div class="layui-form-item">
                  ...
                  <div class="layui-input-inline input-custom-width">
                    <select name="parent_id" lay-verify=""><option value="">请选择</option><option value="0" selected="">≡ 作为一级文件夹 ≡</option><option value="1">我的文件夹</option><option value="8">├─1</option><option value="9">├─PHP</option><option value="10">├─new</option><option value="11">├─WEB前端</option><option value="2">共享文件夹</option><option value="13">├─1</option><option value="14">├─3</option><option value="3"></option><option value="4">demo3</option><option value="5">├─demo</option><option value="6">├─demo2</option><option value="7">├─demo1</option></select>
                  </div>
                  <div class="layui-form-mid layui-word-aux"></div>
                </div>
                <div class="layui-form-item">
                  ...
                  <div class="layui-input-inline input-custom-width">
                    <input type="text" name="name" value="" lay-verify="required" autocomplete="off" placeholder="请输入文件夹名称" class="layui-input">
                  </div>
                </div>
