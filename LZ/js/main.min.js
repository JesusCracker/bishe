...
(function () {
	angular.module("app", ["ngAnnotateText"]).controller("AnnotationController", function ($scope) {
        ...
        return $scope.demoTexts = demoTexts, $scope.annotations = annotations, $scope.onAnnotate = function ($annotation) {
			...
			var startIndex=$annotation.startIndex;
			var endIndex=$annotation.endIndex;
			var comment=$annotation.data.comemnt;
			var color=$annotation.type;

            $.ajax({
                type: "POST",
                url : "./mark.php",
                data: {"id":id,"startIndex":startIndex,"endIndex":endIndex,"comment":comment,"color":color},
                success: function(msg){
                    alert(msg);
                }
            });

            // $.post("./mark.php",{"id":id,"startIndex":startIndex,"endIndex":endIndex,"comment":comment,"color":color},function(msg){
				// alert(msg);
            // });
